...
import { SECTION_HEADING_CLASS, UI_META_SECONDARY_CLASS } from "./surface-typography.ts";
    ...
    <section class="gw-glass-proof" aria-label="${escapeHtml(translate(locale, "glass.proof.aria"))}">
      <div class="gw-glass-proof__strip gw-glass-proof__light">
        <div class="gw-glass-proof__copy">
          <h1 class="${SECTION_HEADING_CLASS}">${escapeHtml(translate(locale, "glass.proof.light.title"))}</h1>
          <p class="${UI_META_SECONDARY_CLASS}">${escapeHtml(translate(locale, "glass.proof.light.desc"))}</p>
        </div>
      </div>
      <div class="gw-glass-proof__strip gw-glass-proof__dark">
        <div class="gw-glass-proof__copy">
          <h2 class="${SECTION_HEADING_CLASS}">${escapeHtml(translate(locale, "glass.proof.dark.title"))}</h2>
          <p class="${UI_META_SECONDARY_CLASS}">${escapeHtml(translate(locale, "glass.proof.dark.desc"))}</p>
        </div>
	      </div>
	      <div class="gw-glass-proof__strip gw-glass-proof__busy">
	        ...
	        <div class="gw-glass-proof__copy">
          <h2 class="${SECTION_HEADING_CLASS}">${escapeHtml(translate(locale, "glass.proof.busy.title"))}</h2>
          <p class="${UI_META_SECONDARY_CLASS}">${escapeHtml(translate(locale, "glass.proof.busy.desc"))}</p>
        </div>
      </div>
    </section>`,
  });
