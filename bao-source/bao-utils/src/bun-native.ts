...
import { LOOPBACK_FALLBACK_HOST } from "@baohaus/bao-constants/loopback-hosts";
 ...
 * @param host - Host to bind to (default: canonical loopback from @baohaus/bao-constants/loopback-hosts)
 */
 ...
 * Bun 1.3.11+: Uses promise rejection handling instead of synchronous exception capture.
 *
 * @example
