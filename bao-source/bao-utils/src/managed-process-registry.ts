 ...
 *
 * @baohaus/bao-utils/managed-process-registry
 */
...
} from "@baohaus/bao-schemas/platform-runtime.schemas";
import { toResult } from "./async-result.ts";
...
export async function registerManagedProcessHandle(
  ...
  registration.process.exited.then(async (exitCode) => {
