...
/**
 * WsEnvelopeV1 encode/decode (no telemetry or scanner table logic).
 *
 * @internal
 */
...
import { REALTIME_FLATBUFFERS_PROTOCOL_VERSION } from "./realtime-flatbuffers-protocol-surface.internal";
import { normalizeOptionalString, toUint8Array } from "./realtime-flatbuffers-util.internal";
