...
constructor(
    ...
    return withContext(Dispatchers.IO) {
      ...
      try {
        ...
        StructuredLog.d(
          ...
          "model" to modelName,
          "fileCount" to downloadSpecs.size,
          "hasExtraDataFiles" to extraDataFileNames.isNotEmpty(),
        )
          ...
          val result = huggingFaceModelManager.downloadModel(
            ...
            onProgress = { progress ->
              ...
              if (now - lastSetProgressTs > 200) {
                ...
                StructuredLog.d(
                  TAG,
                  "model_download_progress_updated",
                  "model" to modelName,
                  "downloadedBytes" to downloadedBytes,
                  "rateBytesPerSecond" to rateBytesPerSecond,
                )
        ...
        StructuredLog.e(TAG, "model_download_failed", e, "model" to modelName)
  ...
  private fun failureResult(message: String): Result {
    StructuredLog.e(TAG, "model_download_worker_failed", "message" to message)
