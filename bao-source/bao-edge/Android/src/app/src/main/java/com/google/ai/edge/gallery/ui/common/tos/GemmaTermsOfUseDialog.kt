...
import com.google.ai.edge.gallery.ui.common.buildLocalizedAnnotatedText
    ...
    Card(shape = RoundedCornerShape(28.dp)) {
      Column(modifier = Modifier.padding(horizontal = 24.dp).padding(bottom = 24.dp)) {
        ...
        Column(modifier = Modifier.verticalScroll(rememberScrollState()).weight(1f, fill = false)) {
          val gemmaTermsLinkText = stringResource(R.string.tos_dialog_gemma_link_text)
          Text(
            buildLocalizedAnnotatedText(
              text =
                stringResource(
                  R.string.tos_dialog_gemma_body,
                  BaoEdgeRuntimeConfig.appName,
                  gemmaTermsLinkText,
                ),
              trackedLinkText = gemmaTermsLinkText,
              trackedLinkUrl = BaoEdgeRuntimeConfig.gemmaTermsUrl,
            ),
