...
data class CustomColors(
  ...
  val onUserBubbleColor: Color = Color.Transparent,
...
/** Gold metallic linear gradient — matches CSS var(--v-gold-gradient) and iOS BaoEdgeTheme. */
val goldMaterialBrush: Brush = Brush.linearGradient(
  colors = listOf(goldGradientLight, goldGradientMid, goldGradientDeep),
  start = Offset(0f, 0f),
  end = Offset(Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY),
)

/** Gold radial shimmer — used for surface glow effects. */
fun goldSurfaceGlowBrush(center: Offset = Offset(0.3f, 0.2f)): Brush = Brush.radialGradient(
  colors = listOf(goldGradientMid.copy(alpha = 0.15f), Color.Transparent),
  center = center,
  radius = 400f,
)
...
val lightCustomColors =
  CustomColors(
    ...
    taskIconShapeBgColor = surfaceContainerLowestLight,
    ...
    onUserBubbleColor = onUserBubbleLight,
    linkColor = linkLight,
...
val darkCustomColors =
  CustomColors(
    ...
    onUserBubbleColor = onUserBubbleDark,
...
/** Bao Edge-branded theme composable. */
@Composable
fun BaoEdgeTheme(content: @Composable () -> Unit) {
