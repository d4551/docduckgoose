...
object ProjectConfig {
  ...
  //
  val clientId = BaoEdgeRuntimeConfig.oauth.clientId
  ...
  // "build.gradle.kts".
  val redirectUri = BaoEdgeRuntimeConfig.oauth.redirectUri
  private val modelSourceBaseUrl = BaoEdgeRuntimeConfig.modelSourceBaseUrl.trimEnd('/')
