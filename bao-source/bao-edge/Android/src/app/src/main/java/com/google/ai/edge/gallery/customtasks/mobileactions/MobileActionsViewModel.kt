...
constructor(
  ...
  private val fallbackExecutor: BaoEdgeRpaFallbackExecutor,
) : ViewModel() {
  ...
  fun processUserPrompt(
    ...
    viewModelScope.launch(Dispatchers.Default) {
      StructuredLog.d(
        TAG,
        "mobile_actions_prompt_processing_started",
        "model_name" to model.name,
        "prompt_length" to userPrompt.length,
      )
      ...
      StructuredLog.d(
        TAG,
        "mobile_actions_conversation_reset_wait_started",
        "model_name" to model.name,
      )
      isResettingConversation.first { !it }
      StructuredLog.d(
        TAG,
        "mobile_actions_conversation_reset_wait_completed",
        "model_name" to model.name,
      )
      ...
      conversation
        ...
        .catch {
          StructuredLog.e(
            TAG,
            "mobile_actions_inference_failed",
            it,
            "model_name" to model.name,
          )
  ...
  private fun setFlashlight(context: Context, isEnabled: Boolean): String {
    ...
    try {
      ...
      StructuredLog.e(
        TAG,
        "mobile_actions_flashlight_capability_failed",
        e,
    ...
    cameraId?.let { id ->
      try {
        ...
        StructuredLog.e(
          TAG,
          "mobile_actions_flashlight_toggle_failed",
          e,
          "enabled" to isEnabled,
          "has_camera_id" to true,
        )
        return e.message ?: context.getString(R.string.unknown_error)
      }
    }
  ...
  private fun createContact(
    ...
    try {
      ...
      StructuredLog.e(
        TAG,
        "mobile_actions_create_contact_failed",
        e,
        "has_email" to email.isNotBlank(),
        "has_phone_number" to phoneNumber.isNotBlank(),
      )
      return e.message ?: context.getString(R.string.unknown_error)
    }
  ...
  private fun sendEmail(context: Context, to: String, subject: String, body: String): String {
    ...
    try {
      ...
      StructuredLog.e(
        TAG,
        "mobile_actions_send_email_failed",
        e,
        "has_recipient" to to.isNotBlank(),
        "has_subject" to subject.isNotBlank(),
        "has_body" to body.isNotBlank(),
      )
      return e.message ?: context.getString(R.string.unknown_error)
    }
  ...
  private fun showLocationOnMap(context: Context, location: String): String {
    ...
    try {
      ...
      StructuredLog.e(
        TAG,
        "mobile_actions_show_location_failed",
        e,
        "location_length" to location.length,
      )
      return e.message ?: context.getString(R.string.unknown_error)
    }
  ...
  private fun openWifiSettings(context: Context): String {
    ...
    try {
      ...
      StructuredLog.e(TAG, "mobile_actions_open_wifi_settings_failed", e)
      return e.message ?: context.getString(R.string.unknown_error)
    }
  ...
  private fun createCalendarEvent(context: Context, datetime: String, title: String): String {
    ...
    try {
      ...
      StructuredLog.w(
        TAG,
        "mobile_actions_calendar_datetime_parse_failed",
        "input_length" to datetime.length,
    ...
    try {
      ...
      StructuredLog.e(
        TAG,
        "mobile_actions_create_calendar_event_failed",
        e,
