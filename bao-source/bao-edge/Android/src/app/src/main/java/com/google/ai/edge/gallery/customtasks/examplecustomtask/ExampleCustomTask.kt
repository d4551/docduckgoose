...
class ExampleCustomTask @Inject constructor() : CustomTask {
  override val task: Task =
    Task(
      ...
      label = "Model Viewer",
      labelResId = R.string.task_model_viewer,
      category = CategoryInfo(id = "example", labelStringRes = R.string.category_example),
      icon = Icons.Outlined.TextFields,
      description = "",
      descriptionResId = R.string.task_model_viewer_description,
      docUrl =
        BaoEdgeRuntimeConfig.sourceRepositoryBlobUrl(
      ...
      models =
        mutableListOf(
          Model(
            name = "example_local_model",
            displayNameResId = R.string.model_example_local_name,
            infoResId = R.string.model_example_local_info,
          ...
          Model(
            name = "example_remote_model",
            displayNameResId = R.string.model_example_remote_name,
            infoResId = R.string.model_example_remote_info,
            url =
              BaoEdgeRuntimeConfig.sourceRepositoryFileUrl("README.md"),
            sizeInBytes = 10_615L,
