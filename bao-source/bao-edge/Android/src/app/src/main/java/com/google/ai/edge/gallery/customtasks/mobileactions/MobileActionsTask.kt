...
class MobileActionsTask @Inject constructor() : CustomTask {
  ...
  override val task =
    Task(
      ...
      description = "",
      descriptionResId = R.string.task_mobile_actions_description,
      docUrl = BaoEdgeRuntimeConfig.liteRtLmKotlinReadmeUrl,
      sourceCodeUrl =
        BaoEdgeRuntimeConfig.sourceRepositoryTreeUrl(
          "Android/src/app/src/main/java/com/google/ai/edge/gallery/customtasks/mobileactions"
        ),
