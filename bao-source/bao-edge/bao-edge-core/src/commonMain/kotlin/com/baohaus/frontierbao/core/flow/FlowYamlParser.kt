package com.baohaus.baoedge.core.flow
...
object FlowYamlParser {
  ...
  private fun CommandTarget.toYamlScalar(): String {
    return when {
      ...
      textContains != null -> "\"textContains=${textContains.escape()}\""
      textStartsWith != null -> "\"textStartsWith=${textStartsWith.escape()}\""
      contentDescriptionContains != null -> "\"contentDescriptionContains=${contentDescriptionContains.escape()}\""
      x != null && y != null -> "\"$x,$y\""
      else -> "\"\""
    }
  }
  ...
  private fun CommandTarget.toYamlScalarForInline(): String {
    return when {
      ...
      textContains != null -> "textContains=$textContains"
      textStartsWith != null -> "textStartsWith=$textStartsWith"
      contentDescriptionContains != null -> "contentDescriptionContains=$contentDescriptionContains"
      x != null && y != null -> "$x,$y"
      else -> ""
    }
  }
  ...
  private fun String.toTarget(): CommandTarget {
    return when {
      ...
      startsWith("textContains=") ->
        CommandTarget(textContains = removePrefix("textContains="))
      startsWith("textStartsWith=") ->
        CommandTarget(textStartsWith = removePrefix("textStartsWith="))
      startsWith("contentDescriptionContains=") ->
        CommandTarget(contentDescriptionContains = removePrefix("contentDescriptionContains="))
