package com.baohaus.baoedge.core.error
...
/** Typed error details envelope used by all Bao Edge boundaries. */
@Serializable
...
data class DriverArtifacts(
  ...
  /** Clipboard text read by clipboardRead command, when available. */
  @SerialName("clipboardContent") val clipboardContent: String? = null,
)
