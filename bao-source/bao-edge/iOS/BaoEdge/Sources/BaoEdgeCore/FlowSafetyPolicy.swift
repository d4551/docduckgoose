...
/// Risk level for flow commands, aligned with Android BaoEdgeFlowSafetyPolicy.
...
/// Mirrors the Android BaoEdgeFlowSafetyPolicy risk classification.
public struct FlowSafetyPolicy: Sendable {
    ...
    public static func classifyRisk(_ command: FlowCommand) -> FlowCommandRisk {
        switch command {
        case .launchApp, .screenshot, .readVisibleState, .clipboardRead, .hideKeyboard, .waitForAnimation:
            return .low
