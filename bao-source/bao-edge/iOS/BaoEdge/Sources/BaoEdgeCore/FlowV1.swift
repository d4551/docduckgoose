...
public struct CommandTarget: Codable, Equatable {
    ...
    public init(
        ...
        textStartsWith: String? = nil,
        contentDescriptionContains: String? = nil,
        x: Int? = nil,
        y: Int? = nil
    ) {
        ...
        self.textStartsWith = textStartsWith
        self.contentDescriptionContains = contentDescriptionContains
        self.x = x
        self.y = y
    }
}
...
extension FlowCommand: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "readVisibleState": self = .readVisibleState
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .readVisibleState:
            try container.encode("readVisibleState", forKey: .type)
        case .clipboardRead:
