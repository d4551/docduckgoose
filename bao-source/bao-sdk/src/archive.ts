/**
 * `.bao` archive contract constants and helpers.
 *
 * Canonical archive layout consumed by schema validation, installers,
 * registry persistence, and archive generation.
 *
 * @module @baohaus/bao-sdk/archive
 */
...
/** Ordered platform slice identifiers for deterministic archive generation. */
...
/**
 * Resolve canonical archive payload root for one platform slice.
 *
...
/**
 * Resolve keep-file path for shared payload directory.
 *
...
/**
 * Resolve keep-file path for one platform slice.
 *
 * @param platformId - Canonical platform identifier.
