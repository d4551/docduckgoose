...
export function parseRateLimitHeaders(headers: HeaderSource): RateLimitInfo {
  return {
    limit: parseHeaderNumber(getHeaderValue(headers, RATE_LIMIT_HEADERS.LIMIT)),
    remaining: parseHeaderNumber(getHeaderValue(headers, RATE_LIMIT_HEADERS.REMAINING)),
    resetAfter: parseHeaderNumber(getHeaderValue(headers, RATE_LIMIT_HEADERS.RESET)),
    retryAfter: parseHeaderNumber(getHeaderValue(headers, RATE_LIMIT_HEADERS.RETRY_AFTER)),
    policy: getHeaderValue(headers, RATE_LIMIT_HEADERS.POLICY) ?? undefined,
    tokenLimit: parseHeaderNumber(getHeaderValue(headers, RATE_LIMIT_HEADERS.TOKEN_LIMIT)),
    tokenRemaining: parseHeaderNumber(getHeaderValue(headers, RATE_LIMIT_HEADERS.TOKEN_REMAINING)),
    tokenReset: parseHeaderNumber(getHeaderValue(headers, RATE_LIMIT_HEADERS.TOKEN_RESET)),
  };
}
