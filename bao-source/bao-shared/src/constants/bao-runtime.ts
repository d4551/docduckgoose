/**
 * BaoControlPlane runtime shared policy constants.
 *
 ...
 */
/**
 * Minimum timeout accepted by BaoControlPlane runtime probes.
 */
...
/**
 * Redis key prefix used for BaoControlPlane runtime snapshot entries.
 */
export const BAO_RUNTIME_CACHE_KEY_PREFIX: "bao-runtime" = "bao-runtime" as const;

/**
 * Redis pub/sub channel used to invalidate BaoControlPlane runtime snapshots.
 */
export const BAO_RUNTIME_CACHE_INVALIDATION_CHANNEL: "bao-runtime:invalidate" =
  "bao-runtime:invalidate" as const;

/**
 * Canonical fallback timestamp used by synthetic BaoControlPlane runtime snapshots.
 */
...
/**
 * Canonical BaoControlPlane runtime probe error categories.
 */
...
/**
 * Union type for BaoControlPlane runtime probe error categories.
 */
