...
} from "../../../schemas/autonomy-integration.schemas";
 ...
 */
export const AutonomyIntegrationContractV1: VersionedContractV1 = {
 ...
 */
export const AutonomyIntegrationRefreshContractV1: VersionedContractV1 = {
  version: CONTRACT_VERSION,
