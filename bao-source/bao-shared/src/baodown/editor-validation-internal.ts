/**
 * BaoDown graph structural validation internals.
 *
 * Used by editor-validation.ts — not part of public API.
 *
 * @shared/baodown/editor-validation-internal
 */

import type { BaoDownEdgeKind, BaoDownGraph } from "../schemas/baodown/baodown-flow.schemas.ts";
import {
  BAODOWN_CONTROL_EDGE_KIND,
  BAODOWN_DATA_EDGE_KIND,
  BAODOWN_GRAPH_SCHEMA_VERSION,
} from "./baodown-graph-contract.ts";
import type { BaoDownEditorValidationIssue } from "./editor-validation.ts";
...
export function isBaoDownGraphValue(value: unknown): value is BaoDownGraph {
