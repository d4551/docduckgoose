...
describe("package contract", () => {
  test("ships built dist exports and keeps source fixtures active", async () => {
    ...
    expect(pkg.name).toBe("@baohaus/bao-schemas");
    expect(pkg.scripts.test).toBe("bun test");
    expect(pkg.files.includes("dist")).toBe(true);
    expect(pkg.exports["./bao-install/source-resolution.schemas"]).toEqual({
      bun: "./dist/bao-install/source-resolution.schemas.js",
      import: "./dist/bao-install/source-resolution.schemas.js",
      types: "./dist/bao-install/source-resolution.schemas.d.ts",
      default: "./dist/bao-install/source-resolution.schemas.js",
    });
