...
const NonEmptyString = TypeExports.String({ minLength: 1 });
const NullableString = TypeExports.Union([TypeExports.Null(), NonEmptyString]);
 ...
 * Plugin scope schema.
 */
export const ServerPluginScopeSchema: TUnion<
  [TLiteral<"public" | "db-backed">, ...TLiteral<"public" | "db-backed">[]]
 ...
 * Plugin kind schema.
 */
export const ServerPluginKindSchema: TUnion<
  [TLiteral<"core" | "api" | "extension">, ...TLiteral<"core" | "api" | "extension">[]]
 ...
 */
export const ServerPluginPositionSchema: TUnion<
  [TLiteral<"before" | "after">, ...TLiteral<"before" | "after">[]]
 ...
 */
export const ServerPluginSourceSchema: TUnion<
  [
    TLiteral<"api-group" | "core-group" | "extension">,
    ...TLiteral<"api-group" | "core-group" | "extension">[],
  ]
 ...
 */
export const ServerPluginRegistrySourceSchema: TUnion<
  [TLiteral<"static" | "db" | "extensible">, ...TLiteral<"static" | "db" | "extensible">[]]
 ...
 */
export const ServerPluginManifestSourceSchema: TUnion<
  [TLiteral<"runtime" | "build">, ...TLiteral<"runtime" | "build">[]]
 ...
 */
export const ServerPluginTrustBoundarySchema: TUnion<
  [
    TLiteral<"internal" | "extension" | "external">,
    ...TLiteral<"internal" | "extension" | "external">[],
  ]
 ...
 */
export const ServerPluginRegistryItemSchema = TypeExports.Object(
  {
    name: NonEmptyString,
    ...
    position: TypeExports.Optional(ServerPluginPositionSchema),
    ...
    dependsOn: TypeExports.Array(NonEmptyString),
    conflictsWith: TypeExports.Array(NonEmptyString),
    extends: TypeExports.Array(NonEmptyString),
    provides: TypeExports.Array(NonEmptyString),
    requires: TypeExports.Array(NonEmptyString),
    signature: NonEmptyString,
    fingerprint: NonEmptyString,
    trustBoundary: ServerPluginTrustBoundarySchema,
    trusted: TypeExports.Boolean(),
    interfaceCompatible: TypeExports.Boolean(),
    capabilityCompatible: TypeExports.Boolean(),
  },
  {
 ...
 */
export const ReadServerPluginRegistryItemSchema = TypeExports.Object(
  {
 ...
 */
export const ServerPluginManifestSchema: TObject<
  {
    readonly registryHash: TString;
    readonly version: TString;
    readonly createdAt: TString;
    readonly routeCount: TInteger;
    readonly pluginCount: TInteger;
    readonly source: TUnion<[TLiteral<"runtime" | "build">, ...TLiteral<"runtime" | "build">[]]>;
    readonly manifestHash: TString;
    readonly manifestSignature: TString;
  },
  | "source"
  | "version"
  | "registryHash"
...
> = TypeExports.Object(
  {
    ...
    routeCount: TypeExports.Integer({ minimum: 0 }),
    pluginCount: TypeExports.Integer({ minimum: 0 }),
 ...
 */
export const ForwardCompatibleServerPluginRegistryItemSchema = TypeExports.Object(
  {
    ...ServerPluginRegistryItemSchema.properties,
  },
  {
 ...
 */
export const SystemPluginsResponseSchema = TypeExports.Object(
  {
    ok: TypeExports.Literal(true),
    count: TypeExports.Integer({ minimum: 0 }),
    updatedAt: TypeExports.String({ format: "date-time" }),
    manifest: ServerPluginManifestSchema,
    plugins: TypeExports.Array(ForwardCompatibleServerPluginRegistryItemSchema),
  },
  {
    additionalProperties: true,
  },
 ...
 */
export const ReadSystemPluginsResponseSchema = TypeExports.Object(
  {
    ok: TypeExports.Literal(true),
    count: TypeExports.Integer({ minimum: 0 }),
    updatedAt: TypeExports.String({ format: "date-time" }),
    manifest: ServerPluginManifestSchema,
    plugins: TypeExports.Array(ReadServerPluginRegistryItemSchema),
  },
  {
    additionalProperties: true,
  },
 ...
 */
export const ServerPluginLookupErrorCodeSchema: TUnion<
  [
    TLiteral<
 ...
 */
export const ServerPluginLookupErrorEnvelopeSchema: TObject<
  {
    readonly ok: TLiteral<false>;
    readonly error: TObject<
      {
        readonly code: TUnion<
          [
            TLiteral<
              | "PLUGIN_LOOKUP_FAILED"
              | "PLUGIN_MANIFEST_INVALID"
