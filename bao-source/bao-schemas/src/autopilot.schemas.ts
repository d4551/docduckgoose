...
import type { Static, TBoolean, TLiteral, TObject, TUnion } from "@baohaus/baobox/elysia";
 ...
 */
export const AutopilotTypeSchema: TUnion<
  [TLiteral<"px4" | "ardupilot" | "generic">, ...TLiteral<"px4" | "ardupilot" | "generic">[]]
 ...
 */
export const VehicleClassSchema: TUnion<
  [
    TLiteral<"multirotor" | "fixed-wing" | "vtol" | "rover" | "boat" | "submarine">,
    ...TLiteral<"multirotor" | "fixed-wing" | "vtol" | "rover" | "boat" | "submarine">[],
  ]
 ...
 * Flight mode schema.
 */
export const FlightModeSchema: TUnion<
  [
    TLiteral<
      | "STABILIZE"
      | "ACRO"
 ...
 */
export const AutopilotCapabilitiesSchema: TObject<
  {
    readonly supportsOffboard: TBoolean;
    readonly supportsMission: TBoolean;
    readonly supportsGeofence: TBoolean;
    readonly supportsRallyPoints: TBoolean;
    readonly supportsFtp: TBoolean;
    readonly supportsParamFloat: TBoolean;
    readonly supportsParamUnion: TBoolean;
    readonly supportsSetActuatorTarget: TBoolean;
    readonly supportsFlightTermination: TBoolean;
    readonly supportsCompassCalibration: TBoolean;
  },
  | "supportsOffboard"
  | "supportsMission"
  | "supportsGeofence"
...
> = TypeExports.Object(
  {
    supportsOffboard: TypeExports.Boolean({ description: "Supports offboard control mode" }),
    supportsMission: TypeExports.Boolean({ description: "Supports mission upload/download" }),
    supportsGeofence: TypeExports.Boolean({ description: "Supports geofence configuration" }),
    supportsRallyPoints: TypeExports.Boolean({ description: "Supports rally point configuration" }),
    supportsFtp: TypeExports.Boolean({ description: "Supports MAVLink FTP" }),
    supportsParamFloat: TypeExports.Boolean({ description: "Supports float parameters" }),
    supportsParamUnion: TypeExports.Boolean({ description: "Supports union parameters" }),
    supportsSetActuatorTarget: TypeExports.Boolean({
      description: "Supports direct actuator control",
    }),
    supportsFlightTermination: TypeExports.Boolean({
      description: "Supports flight termination command",
    }),
    supportsCompassCalibration: TypeExports.Boolean({
 ...
 */
export const AutopilotInfoSchema = TypeExports.Object(
  {
    type: AutopilotTypeSchema,
    mavType: TypeExports.Integer({ description: "MAV_TYPE enum value" }),
    autopilot: TypeExports.Integer({ description: "MAV_AUTOPILOT enum value" }),
    version: TypeExports.Optional(TypeExports.String({ description: "Firmware version string" })),
    capabilities: TypeExports.Optional(
      TypeExports.Integer({ description: "MAV_PROTOCOL_CAPABILITY bitmask" }),
    ),
    customModeMapping: TypeExports.Optional(
      TypeExports.Record(TypeExports.Number(), FlightModeSchema, {
        description: "Custom mode to FlightMode mapping",
      }),
    ),
    vehicleClass: TypeExports.Optional(VehicleClassSchema),
  },
  { additionalProperties: true },
);
 ...
 */
export const ParameterTypeSchema: TUnion<
  [TLiteral<"string" | "float" | "int">, ...TLiteral<"string" | "float" | "int">[]]
 ...
 */
export const ParameterValueSchema = TypeExports.Object(
  {
    ...
    value: TypeExports.Union([TypeExports.Number(), TypeExports.String()], {
      description: "Parameter value",
    }),
    type: ParameterTypeSchema,
    min: TypeExports.Optional(TypeExports.Number({ description: "Minimum allowed value" })),
    max: TypeExports.Optional(TypeExports.Number({ description: "Maximum allowed value" })),
    default: TypeExports.Optional(TypeExports.Number({ description: "Default value" })),
    description: TypeExports.Optional(TypeExports.String({ description: "Parameter description" })),
  },
  { additionalProperties: true },
);
