...
Pre-release. No legacy. Refactor now, not later. Finish to industry best practice or don't open the PR.
...
- **Finish.** Track every item on the to-do list. Half-done is not done. "Mostly works" is broken.
...
If any answer is "no" or "sort of": keep working.
...
**Keep diffs small and focused. Small files, small components. No god modules.**
