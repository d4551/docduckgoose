...
const API_EXPLORER_HTTP_METHOD_SET: ReadonlySet<string> = new Set<string>(
  API_EXPLORER_HTTP_METHODS,
);

/** Fast runtime lookup for API Explorer methods that accept a body payload. */
const API_EXPLORER_BODY_METHOD_SET: ReadonlySet<string> = new Set<string>(
  API_EXPLORER_BODY_METHODS,
);
